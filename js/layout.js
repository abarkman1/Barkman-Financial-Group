/*
  BARKMAN FINANCIAL GROUP — layout.js v10
  Phoenix, AZ · License #22121594

  ROOT CAUSE FIX FOR "DROPDOWN" BUG:
  The footer was injected via insertAdjacentHTML('afterbegin') — meaning it was
  placed at the TOP of the DOM before the page rendered. On mobile, the footer's
  column links (Company / Coverage Options / Legal / Contact) painted at the top
  of the viewport behind the transparent nav, creating a perfect illusion of an
  open dropdown. This was never a CSS dropdown problem. It was always DOM order.

  FIX: Footer is now insertAdjacentHTML('beforeend') — bottom of body where it belongs.
  Nav background on mobile is solid from frame 1 — no transparency on small screens.
*/
...
const LOGO_IMG = `<img src="${_R}BFG_LOGO.png" alt="Barkman Financial Group" width="44" height="44" loading="eager">`;

// NAV — afterbegin is correct for nav
...
<div class="mob-nav" id="mob-nav" role="dialog" aria-label="Navigation" aria-modal="true">
  ...
  <div class="mob-cta-wrap">
    <a href="${_R}contact.html" class="btn btn-gold">Get a Free Consultation &rarr;</a>
  </div>
</div>
...
<nav id="nav" role="navigation" aria-label="Main navigation">
  ...
  <div class="nav-in">
    ...
    <ul class="nav-links" role="list">
      ...
      <li class="dd-parent">
        <button class="nlk dd-toggle" id="dd-btn" type="button"
          aria-haspopup="true" aria-expanded="false" aria-controls="dd-menu">
          Coverage Options <span id="dd-chev" class="nav-chev">›</span>
        </button>
        <ul class="nav-dd" id="dd-menu" role="menu">
          ...
          <li><a href="${_R}supplemental.html"  role="menuitem">Supplemental Coverage</a></li>
        </ul>
      </li>
    ...
    <div class="nav-right">
      <a href="tel:6026800058" class="nav-ph">
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 015.19 12 19.79 19.79 0 012.12 3.35 2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></svg>
        602-680-0058
      </a>
      <a href="${_R}contact.html" class="btn btn-gold nav-cta-btn">Get Covered</a>
      <button class="nav-ham" id="nav-ham" type="button" aria-label="Open menu" aria-expanded="false" aria-controls="mob-nav">
...
// FOOTER — beforeend = bottom of body = where it belongs
// This is the fix. Footer was previously afterbegin, painting at page top.
...
<footer id="site-footer">
  <div class="ft-in">
    <div class="ft-top">
      ...
      <div class="ft-brand">
        <a href="${_R}index.html" class="nav-logo ft-brand-logo">
          <div class="logo-img">${LOGO_IMG}</div>
          <div class="logo-txt">
            <span class="logo-name">BARKMAN</span>
            <span class="logo-sub">Financial Group</span>
        ...
        <p class="ft-tagline">
          ...
          Independent insurance brokerage helping families, retirees, and individuals
          find the right coverage. Phoenix, Arizona. Licensed in 20+ states.
        </p>
      </div>
      ...
      <div class="ft-col">
        <h4>Contact</h4>
        <div class="ft-ci"><span class="ft-ci-icon">📞</span><span class="ft-ci-txt"><a href="tel:6026800058">602-680-0058</a></span></div>
        <div class="ft-ci"><span class="ft-ci-icon">📍</span><span class="ft-ci-txt">Phoenix, Arizona<br>Licensed in 20+ states</span></div>
        <div class="ft-ci"><span class="ft-ci-icon">🕐</span><span class="ft-ci-txt">Mon–Fri 8am–6pm CST<br>Sat 9am–2pm CST</span></div>
        <div class="ft-ci"><span class="ft-ci-icon">🔒</span><span class="ft-ci-txt">Independent. No cost to you.</span></div>
      </div>
